import { ArrowLeft, CheckCircle2, Inbox, ListChecks, Layers } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="rounded-3xl bg-black/50 backdrop-blur-xl border border-white/10 p-8 text-center">
          ...
          <p className="text-white/50 text-sm max-w-md mx-auto mb-8">
            AI-powered summarization of unread messages, open tabs, and unresolved tasks. 
            Get guided closure on everything that's been lingering.
          </p>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-2xl mx-auto">
            {[
              { icon: Inbox, label: "Unread Messages" },
              { icon: Layers, label: "Open Tabs" },
              { icon: ListChecks, label: "Pending Tasks" },
              { icon: CheckCircle2, label: "Close Loops" },
            ].map((item, i) => (
