...
const OPTIONS = [
  ...
  { 
    id: "time_sensitive", 
    label: "Only if time-sensitive", 
    icon: Clock,
    description: "Deadlines and commitments only"
  },
  { 
    id: "balanced", 
    label: "Balanced", 
...
export const InterviewAttention = ({ onNext }: InterviewAttentionProps) => {
      ...
      <div className="max-w-lg w-full space-y-10">
        ...
        <div className="text-center space-y-3">
          ...
          <h2 className="text-2xl font-light text-foreground/90">
            How do you prefer interruptions?
          </h2>
        </div>
